...
#
# NOTE: lives in lib/ (not webui/) so it is available inside the Docker image,
# which excludes webui/ via .dockerignore. The web UI (web/api.py, web/services.py)
# imports directly from here; webui/headless_optimizer.py re-exports from here.
        ...
        try:
            ...
            proposal = StrategistProposal(
                ...
                prior_evidence=PriorEvidence(
                    ...
                    note="Auto-generated by the headless optimizer.",
                ),
                arm=arm,
            )
